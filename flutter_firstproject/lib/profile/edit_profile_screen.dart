...
// NOTE: Replace all Colors.white with ThemeColor.primary
  ...
  void _onImageButtonPressed(ImageSource source, BuildContext context,
    ...
    try {
      ...
      if (pickedFile == null) {
        ...
        await profileRepo.cropImage(pickedFile.path, context, targetPath);
      }
    } catch (e) {
                                      ...
                                      Container(
                                        ...
                                        decoration: const BoxDecoration(
                                          gradient: LinearGradient(
                                              ...
                                              colors: [
                                                // NOTE: DO NOT CHANGE THIS Colors.white
                                                Colors.white,
                                                // NOTE: Replace this with ThemeColor.secondary
                                                Colors.black
                                              ], // red to yellow
                                              tileMode: TileMode
